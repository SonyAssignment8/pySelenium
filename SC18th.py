...
#4 Select 2 Gm
wb_one_gram = driver.find_element_by_xpath("//span[text()='Lakshmi Gold Coins']/../..//ul/li/span[text()='2 gram']")
act.move_to_element(wb_coins).click(wb_one_gram).perform()

#5 Verify 2Gm Coin is displaying or not
exp_gold_coin = "2 gram"
wb = driver.find_element_by_xpath("//h1[text()='2 gram 24 KT Lakshmi Gold Coin']")
