...
for i in default_price:
    dPrice = default_price_lst.append(i.text.replace("RS.", "").replace(",", ""))
print(default_price_lst)
...
for i in sorted_price:
    sPrice = sorted_price_lst.append(i.text.replace("RS.", "").replace(",", ""))
print(sorted_price_lst)
