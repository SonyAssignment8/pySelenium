...
class BlueStone:
    ...
    def coins(self):
        ...
        m=self.driver.find_element_by_xpath("//span[text()='Lakshmi Gold Coins']")
        ...
        print(actuallst)
        assert "10 gram" in actuallst, "Coin is not in the list"
        print("10 gram coin present in the list")
