...
element_gram=driver.find_element_by_xpath("//span[text()='Lakshmi Gold Coins']/../..//ul/li/span[text()='5 gram']")

action.move_to_element(element).click(element_gram).perform()
time.sleep(4)
act=driver.find_element_by_xpath("//h1[text()='5 gram 24 KT Lakshmi Gold Coin']")
actual=act.text
exp='5 gram'
