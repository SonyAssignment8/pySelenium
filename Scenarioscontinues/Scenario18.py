...
4. Go to Lakshmi gold coins and Select 2 Gm
...
element_gram=driver.find_element_by_xpath("//span[text()='Lakshmi Gold Coins']/../..//ul/li/span[text()='2 gram']")

action.move_to_element(element).click(element_gram).perform()
time.sleep(4)
act=driver.find_element_by_xpath("//h1[text()='2 gram 24 KT Lakshmi Gold Coin']")
actual=act.text
exp='2 gram'
