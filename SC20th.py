...
#4 Select 10 Gm
wb_one_gram = driver.find_element_by_xpath("//span[text()='Lakshmi Gold Coins']/../..//ul/li/span[text()='10 gram']")
act.move_to_element(wb_coins).click(wb_one_gram).perform()

#5 Verify 10Gm Coin is displaying or not
exp_gold_coin = "10 gram"
wb = driver.find_element_by_xpath("//h1[text()='10 gram 24 KT Lakshmi Gold Coin']")
