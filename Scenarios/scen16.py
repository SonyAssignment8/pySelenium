...
#4 Select 20 Gm
wb_one_gram = driver.find_element_by_xpath("//span[contains(text(),'20 gram')]")
act.move_to_element(wb_coins).click(wb_one_gram).perform()

#5 Verify 1Gm Coin is displaying or not
exp_gold_coin = "20 gram"
wb = driver.find_element_by_xpath("//h1[text()='20 gram 24 KT Gold Coin']")
