...
p1 = Person("ReenaAndAtul", 36)
p1.myfunc()
p3 = p1.age = 40    # You can modify properties on objects like this: now age is changed from 36 to 40
print(p3)
...
# The pass Statement class definitions cannot be empty, but if you for some reason have a class definition with no
